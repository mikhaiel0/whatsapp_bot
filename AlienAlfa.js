...
│
╰───「 *🥳ʟᴇᴠᴇʟ ᴜᴘ🥳* 」`)
		  but = [{ buttonId: `!menu`, buttonText: { displayText: '💁𝙈𝙀𝙉𝙐' }, type: 1 }]
          sendButton(from, lvlup, '*ＪＩＭＢＲＯＯＴＴＡＮ*', but)
...
Alienalfa.sendMessage(from, { contentText: `${teks}`, footerText: `${menu}`, buttons: [{ buttonId: `${prefix}alfa`, buttonText: { displayText: '💁𝙈𝙀𝙉𝙐' }, type: 1 },{ buttonId: `${prefix}sc`, buttonText: { displayText: '💁𝙎𝘾𝙍𝙄𝙋𝙏' }, type: 1 },{ buttonId: `${prefix}developer`, buttonText: { displayText: '🧎𝘿𝙀𝙑𝙀𝙇𝙊𝙋𝙀𝙍' }, type: 1 } ], headerType: 'LOCATION📍', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: alfaimg, contextInfo: {mentionedJid: [senderr,pemilik]}}}, 'buttonsMessage')
break
case 'menu':
case 'list':
case 'alfa':
...
buttonText: '💁𝙈𝙀𝙉𝙐 ',
footerText: `*${botname}*`,
description: `Hey 👋 @${senderr.split('@')[0]}, Please select the menu here`,
sections: [
{
"title": `ＪＩＭＢＲＯＯＴＴＡＮ - ${time}`,
rows: [
{
"title": "𒆜𝙂𝙧𝙤𝙪𝙥 𝙈𝙚𝙣𝙪",
...
//════════════════[ Template Location ]════════════════//
   	   ...
   	   if   (loc === true )
   	      {
   	         Alienalfa.sendMessage(from, { contentText: `${menu}`, footerText: `*_ＡＬＩＥＮ ＡＬＦＡ_*`, buttons: [{ buttonId: `${prefix}alfa`, buttonText: { displayText: '𒆜𝙈??𝙉𝙐 ' }, type: 1 },{ buttonId: `${prefix}owner`, buttonText: { displayText: '𒆜𝙊𝙒𝙉𝙀𝙍' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', thumbnail:fs.readFileSync('./media/Alfa.jpg'), contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
   	      }
